    ...
    <div className="pt-24 pb-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-[13px] text-slate-500 mb-10 font-medium">
          ...
          <span className="text-slate-800">Tentang Kami</span>
        </div>

        {/* Hero Section */}
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-24 mb-32 items-center relative z-10">
          <div className="max-w-xl z-20">
            <p className="text-xs font-bold text-slate-500 tracking-widest uppercase mb-4">TENTANG YAYASAN KRISNA</p>
            <h1 className="text-4xl lg:text-5xl xl:text-[3.5rem] font-bold text-[#14532d] leading-[1.1] mb-6 font-display">
              Menghubungkan Kebaikan dari Arab Saudi untuk Indonesia
            </h1>
            <p className="text-[15px] text-slate-600 leading-relaxed font-medium">
              Yayasan KRISNA menjembatani dukungan para donatur dari Arab Saudi untuk menghadirkan perubahan nyata bagi masyarakat di pelosok Indonesia.
            </p>
          </div>

          <div className="relative z-10 w-[110%] -ml-[5%] lg:w-full lg:ml-0 h-[450px] lg:h-[600px]">
            <img src={genericImg} alt="Hero" className="w-full h-full object-cover rounded-l-[3rem] lg:rounded-[3rem] shadow-xl" />
            
            {/* Stats bar */}
            <div className="absolute -bottom-12 right-0 lg:right-auto lg:left-1/2 lg:-translate-x-1/2 bg-white rounded-3xl shadow-xl border border-slate-100 p-6 lg:px-10 lg:py-6 flex flex-wrap lg:flex-nowrap items-center justify-between gap-6 lg:gap-12 w-[90%] lg:w-max mx-auto left-0">
              <div className="flex items-center gap-4 shrink-0">
                <div className="w-12 h-12 rounded-full border border-slate-200 flex items-center justify-center text-[#14532d]">
                  <Heart size={20} />
                </div>
                <div>
        ...
        <div className="text-center mb-16 pt-12 lg:pt-0">
          <h2 className="text-3xl lg:text-4xl font-bold text-[#14532d] font-display flex items-center justify-center gap-4">
        ...
        <div className="grid lg:grid-cols-3 gap-8 mb-32 items-stretch">
          ...
          <div className="flex flex-col items-center text-center justify-center py-12 px-6 relative">
            <div className="w-20 h-20 bg-white rounded-full shadow-2xl flex items-center justify-center mb-8 border border-slate-50 z-10 shrink-0 transform hover:scale-105 transition-transform duration-500">
              <Handshake size={32} className="text-[#14532d]" />
            </div>
          ...
          {/* Saudi Column */}
          <div className="bg-[#f0fdf4] rounded-[2.5rem] p-10 flex flex-col items-center text-center border border-[#dcfce7] relative shadow-lg shadow-[#166534]/5">
            <div className="w-14 h-14 bg-white rounded-full flex items-center justify-center mb-6 shadow-sm absolute -top-7 left-1/2 -translate-x-1/2">
              <div className="w-7 h-7 rounded-full bg-green-700 overflow-hidden flex items-center justify-center border border-slate-100">
            ...
            <ul className="text-left space-y-4 mb-10 w-full text-[13px] text-slate-700">
              {["Semangat berbagi yang tinggi", "Donasi berkelanjutan", "Kepedulian terhadap sesama umat manusia", "Nilai-nilai Islam yang mendorong kebaikan"].map((item, i) => (
                <li key={i} className="flex gap-3 items-start font-medium leading-tight">
                  <CheckCircle2 size={18} className="text-[#166534] shrink-0 fill-[#dcfce7]" /> 
                  <span className="-mt-0.5">{item}</span>
                </li>
              ))}
            </ul>
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 mb-32 items-stretch">
          <div className="bg-white p-10 lg:p-14 rounded-[3rem] border border-slate-100 shadow-xl shadow-slate-200/20 flex flex-col justify-center">
            <h2 className="text-3xl font-bold text-slate-900 mb-6 font-display">Tentang Yayasan KRISNA</h2>
            <p className="text-slate-600 leading-relaxed text-[15px] mb-12 font-medium">
              Yayasan KRISNA adalah organisasi nirlaba yang berkomitmen meningkatkan kualitas hidup masyarakat di daerah terpencil melalui pembangunan infrastruktur dasar dan program pengembangan komunitas yang berkelanjutan.
            </p>
            
            <div className="space-y-8">
              <div className="flex gap-5 items-start">
                <Home size={28} className="text-[#14532d] shrink-0" strokeWidth={1.5} />
                <div>
              ...
              <div className="flex gap-5 items-start">
                <Zap size={28} className="text-[#14532d] shrink-0" strokeWidth={1.5} />
                <div>
              ...
              <div className="flex gap-5 items-start">
                <HeartHandshake size={28} className="text-[#14532d] shrink-0" strokeWidth={1.5} />
                <div>
          ...
          <div className="relative rounded-[3rem] overflow-hidden min-h-[400px] lg:min-h-full">
            ...
            <div className="absolute inset-x-0 bottom-0 top-1/3 bg-gradient-to-t from-[#14532d]/90 to-transparent"></div>
            <div className="absolute bottom-10 left-10 right-10 bg-white/95 backdrop-blur-md p-8 rounded-3xl border border-white text-center shadow-2xl">
              ...
              <p className="text-[15px] font-bold text-[#14532d] mt-3">Jazakumullahu khairan</p>
            </div>
          </div>
        </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-x-8 gap-y-12">
              <div className="flex flex-col items-start pr-4">
                <div className="w-14 h-14 rounded-2xl bg-[#f0fdf4] flex items-center justify-center text-[#14532d] mb-5 border border-[#bbf7d0]">
              ...
              {[
                ...
                <div key={idx} className="flex gap-5 items-start">
                  <div className="w-10 h-10 rounded-full bg-white flex items-center justify-center shadow-lg border border-slate-50 shrink-0">
                    <ShieldCheck size={20} className="text-[#14532d]" />
                  </div>
            ...
            {[
              ...
              <div key={idx} className="space-y-5">
                <div className="flex gap-3 h-[200px]">
                  ...
                  <div className="flex-1 relative rounded-2xl overflow-hidden group shadow-md border-2 border-[#14532d]/10">
                    <img src={genericImg} className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" />
                    <div className="absolute top-3 left-3 px-3 py-1 rounded-full text-[10px] bg-[#14532d]/80 text-white font-bold backdrop-blur-md border border-white/20 uppercase tracking-widest">Sesudah</div>
                  </div>
                </div>
                <p className="text-[12px] font-bold text-slate-600 flex justify-between">
                  ...
                  <span className="flex-1 text-right text-[#14532d] pl-2">{item.label2}</span>
                </p>
              </div>
            ))}
          </div>
        ...
        <div className="grid lg:grid-cols-[1fr_1.8fr] gap-6">
          <div className="bg-[#033120] text-white p-12 rounded-[3.5rem] flex flex-col justify-center text-center shadow-2xl relative overflow-hidden">
            {/* simple abstract pattern */}
            <div className="absolute right-0 top-0 w-48 h-48 bg-[#166534] rounded-full blur-[80px] -translate-y-1/2 translate-x-1/3 opacity-50"></div>
            <div className="relative z-10">
              <p className="text-3xl font-bold mb-6 leading-relaxed bg-[#064e3b] w-max mx-auto p-4 rounded-3xl" style={{fontFamily: "Arial, sans-serif"}}>
                مَا أَنْفَقْتُمْ مِنْ شَيْءٍ فَهُوَ يُخْلِفُهُ
              </p>
              <p className="text-[15px] font-medium opacity-90 leading-relaxed mb-4 italic text-[#bbf7d0]">
          ...
          <div className="bg-[#f8f9fa] rounded-[3.5rem] border border-slate-100 flex overflow-hidden shadow-sm">
            <div className="flex-[1.5] p-12 lg:p-14 flex flex-col justify-center">
              ...
              <div className="flex flex-wrap gap-4">
                <button className="bg-[#14532d] text-white px-8 py-4 rounded-full text-sm font-bold flex items-center gap-3 hover:bg-[#064e3b] transition-all shadow-lg hover:shadow-xl hover:scale-105">
                  <Heart size={18} fill="currentColor" /> Donasi Sekarang
                </button>
                <button className="bg-white text-[#14532d] border border-slate-200 px-8 py-4 rounded-full text-sm font-bold flex items-center gap-3 hover:border-[#14532d] transition-all hover:bg-slate-50">
