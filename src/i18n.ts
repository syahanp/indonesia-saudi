      ...
      id: {
        translation: {
          ...
          account: {
            ...
            new_goodness: "Mulai Kebaikan Baru",
            new_goodness_desc: "Lihat program terbaru kami yang membutuhkan dukungan Anda saat ini.",
            view_projects: "Lihat Proyek",
            data_security: "Keamanan Data",
            data_security_desc: "Data akun Anda dienkripsi secara aman. Kami berkomitmen menjaga privasi setiap donatur kami sesuai standar internasional.",
            category: {
      ...
      en: {
        translation: {
          ...
          account: {
            ...
            new_goodness: "Start New Goodness",
            new_goodness_desc: "Check out our latest programs that need your support right now.",
            view_projects: "View Projects",
            data_security: "Data Security",
            data_security_desc: "Your account data is securely encrypted. We are committed to maintaining the privacy of our donors according to international standards.",
            category: {
      ...
      ar: {
        translation: {
          ...
          dampak_laporan: {
              ...
              currency: "د.إ",
              currency_full: "درهم إماراتي",
              million_plus: "أكثر من {{amount}} مليون د.إ",
              number_plus: "+{{val}}",
              trend_up: "+ {{val}}%",
              thousand: "ألف",
              periods: {
          ...
          account: {
            ...
            chart_categories: "فئة",
            distribution: "توزيع",
            new_goodness: "ابدأ خيراً جديداً",
            new_goodness_desc: "اطلع على أحدث برامجنا التي تحتاج إلى دعمك في الوقت الحالي.",
            view_projects: "عرض المشاريع",
            data_security: "أمن البيانات",
            data_security_desc: "بيانات حسابك مشفرة بشكل آمن. نحن ملتزمون بالحفاظ على خصوصية متبرعينا وفقاً للمعايير الدولية.",
            category: {
